...
| root-folder-blue           | ![root-folder-blue](root-folders/root-folder-blue.png)                     |
| root-folder-blue-outline   | ![root-folder-blue-outline](root-folders/root-folder-blue-outline.png)     |
| root-folder-gray           | ![root-folder-gray](root-folders/root-folder-gray.png)                     |
| root-folder-gray-outline   | ![root-folder-gray-outline](root-folders/root-folder-gray-outline.png)     |
| root-folder-green          | ![root-folder-green](root-folders/root-folder-green.png)                   |
| root-folder-green-outline  | ![root-folder-green-outline](root-folders/root-folder-green-outline.png)   |
| root-folder-orange         | ![root-folder-orange](root-folders/root-folder-orange.png)                 |
| root-folder-orange-outline | ![root-folder-orange-outline](root-folders/root-folder-orange-outline.png) |
| root-folder-pink           | ![root-folder-pink](root-folders/root-folder-pink.png)                     |
| root-folder-pink-outline   | ![root-folder-pink-outline](root-folders/root-folder-pink-outline.png)     |
| root-folder-purple         | ![root-folder-purple](root-folders/root-folder-purple.png)                 |
| root-folder-purple-outline | ![root-folder-purple-outline](root-folders/root-folder-purple-outline.png) |
| root-folder-red            | ![root-folder-red](root-folders/root-folder-red.png)                       |
| root-folder-red-outline    | ![root-folder-red-outline](root-folders/root-folder-red-outline.png)       |
| root-folder-sky            | ![root-folder-sky](root-folders/root-folder-sky.png)                       |
| root-folder-sky-outline    | ![root-folder-sky-outline](root-folders/root-folder-sky-outline.png)       |
| root-folder-yellow         | ![root-folder-yellow](root-folders/root-folder-yellow.png)                 |
| root-folder-yellow-outline | ![root-folder-yellow-outline](root-folders/root-folder-yellow-outline.png) |
